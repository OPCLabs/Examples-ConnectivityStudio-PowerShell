...
$server.Add([UADataVariableExtension]::ReadFunction((New-Object UADataVariable("ReadThisVariable")), 
    [RunspacedDelegateFactory]::NewRunspacedDelegate(
    [System.Func[UAAttributeData[int]]] { New-Object UAAttributeData($random.Next(), [DateTime]::UtcNow.AddMinutes(-10)) }) ))
