...
$dataVariable = [UADataVariableExtension]::ConstantValue((New-Object UADataVariable("Constant")), 42)
$dataVariable.Add([UADataVariableExtension]::ConstantValue((New-Object UADataVariable("NestedConstant")), "abc"))
$server.Add($dataVariable) 

# Create a folder, and a data variable nested inside it.
$folder = New-Object UAFolder("Folder")
$folder.Add([UADataVariableExtension]::ReadWriteValue((New-Object UADataVariable("ReadWrite")), 0))
$server.Add($folder) 
