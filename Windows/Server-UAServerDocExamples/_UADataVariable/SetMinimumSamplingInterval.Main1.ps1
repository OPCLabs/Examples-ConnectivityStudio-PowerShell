...
$server.Add([UADataVariableExtension]::SetMinimumSamplingInterval([UADataVariableExtension]::ReadValueFunction((New-Object UADataVariable("ReadThisVariable")), 
    [RunspacedDelegateFactory]::NewRunspacedDelegate([System.Func[int]] { $random.Next() })), 5 * 1000))
