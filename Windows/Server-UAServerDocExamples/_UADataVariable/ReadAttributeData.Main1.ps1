...
$timer.add_Elapsed([RunspacedDelegateFactory]::NewRunspacedDelegate([System.Timers.ElapsedEventHandler] { param ($sender, $e) $dataVariable.ReadAttributeData = New-Object UAAttributeData($random.Next(), [DateTime]::UtcNow) }))
$timer.Start()
