...
$server.Add([UADataVariableExtension]::WriteValueAction([UADataVariableExtension]::Readable((New-Object UADataVariable("WriteToThisVariable")), $false), 
    [RunspacedDelegateFactory]::NewRunspacedDelegate([System.Action[int]]{ 
        param($value)
