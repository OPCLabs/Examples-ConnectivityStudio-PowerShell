...
[EasyUAServerEndpointStateChangedEventHandler]$ServerOnEndpointStateChanged = {
    param($sender, $e)
    Write-Host "$($e)"
...
# Hook events.
$server.add_EndpointStateChanged([RunspacedDelegateFactory]::NewRunspacedDelegate($ServerOnEndpointStateChanged))
